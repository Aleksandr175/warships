...
class ResearchDictionarySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        ResearchDictionary::create(['id' => config('constants.RESEARCHES.SHIP_SAILS'), 'title' => 'Improved sails', 'description' => 'Better sails - better ships']);
        ResearchDictionary::create(['id' => config('constants.RESEARCHES.SHIP_GUNS'), 'title' => 'Improved guns', 'description' => '+10% to ship attack, allows you to build warships', 'improvement_type' => 'attack', 'base_increment' => 10]);
        ResearchDictionary::create(['id' => config('constants.RESEARCHES.SHIP_HOLD'), 'title' => 'Ship hold', 'description' => 'Increases the capacity of ships by 10%', 'improvement_type' => 'capacity', 'base_increment' => 10]);
